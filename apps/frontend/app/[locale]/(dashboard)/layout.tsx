    ...
    <OrganizationProvider>
      <div className="flex min-h-screen">
        ...
        {/* A deliberately much fainter version of the marketing site's
            ...
            people use daily, not a landing page, so the bar here is "ties
            the visual identity together as ambient texture" rather than
        ...
        <main className="relative flex-1 overflow-y-auto bg-gray-950 px-8 py-8">
          {/* Wrapped in its own `fixed inset-0` container rather than
              ...
              setting the same CSS property don't reliably resolve by
              className string order (only by their order in the generated
              stylesheet), so this wrapper is the safe way to make it
              viewport-fixed. */}
